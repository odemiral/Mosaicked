#############################################################################
# Makefile for building: PhotoMosaic
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Dec 10 23:40:01 2014
# Project:  Photo Mosaic.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile "Photo Mosaic.pro"
#############################################################################
...
Makefile: Photo\ Mosaic.pro  c:/Qt/4.8.6/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile "Photo Mosaic.pro"
